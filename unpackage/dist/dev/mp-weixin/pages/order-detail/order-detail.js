...
var _orderDetail = _interopRequireDefault(__webpack_require__(/*! ./pages/order-detail/order-detail.vue */ 172));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/* harmony import */ var _order_detail_vue_vue_type_template_id_c4ba589e___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./order-detail.vue?vue&type=template&id=c4ba589e& */ 173);
...
var _time = _interopRequireDefault(__webpack_require__(/*! @/common/lib/time.js */ 177));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} //
//
//
//
//
...
//
//
var timer = null;var orderListItem = function orderListItem() {return __webpack_require__.e(/*! import() | components/order/order-list-item */ "components/order/order-list-item").then(__webpack_require__.bind(null, /*! @/components/order/order-list-item.vue */ 359));};var uniListItem = function uniListItem() {return __webpack_require__.e(/*! import() | components/uni-ui/uni-list-item/uni-list-item */ "components/uni-ui/uni-list-item/uni-list-item").then(__webpack_require__.bind(null, /*! @/components/uni-ui/uni-list-item/uni-list-item.vue */ 264));};var price = function price() {return __webpack_require__.e(/*! import() | components/common/price */ "components/common/price").then(__webpack_require__.bind(null, /*! @/components/common/price.vue */ 218));};var card = function card() {return __webpack_require__.e(/*! import() | components/common/card */ "components/common/card").then(__webpack_require__.bind(null, /*! @/components/common/card.vue */ 213));};var commonButton = function commonButton() {return __webpack_require__.e(/*! import() | components/common/common-button */ "components/common/common-button").then(__webpack_require__.bind(null, /*! @/components/common/common-button.vue */ 364));};var _default = { components: { orderListItem: orderListItem, uniListItem: uniListItem, price: price, card: card, commonButton: commonButton }, data: function data() {return { id: 0, no: "", address: { province: "", city: "", district: "", address: "", zip: 0, name: "", phone: "" }, total_price: 0, remark: "", paid_time: null, payment_method: "", payment_no: "", refund_status: "pending", ship_status: "", extra: null, create_time: "", update_time: "", reviewed: 0, order_items: [], couponUserItem: [], end_time: 0, timeDown: '' };}, computed: { // 商品总价
    price: function price() {var p = 0;this.order_items.forEach(function (item) {p += item.pprice * item.num;});return p.toFixed(2);}, path: function path() {var _this$address = this.address,province = _this$address.province,city = _this$address.city,district = _this$address.district,address = _this$address.address;return "".concat(province, " ").concat(city, " ").concat(district, " ").concat(address);}, // 订单状态
    status: function status() {return this.$U.formatStatus({ paid_time: this.paid_time, refund_status: this.refund_status, ship_status: this.ship_status });}, coupon: function coupon() {if (Array.isArray(this.couponUserItem) && this.couponUserItem.length === 0) {return '未使用';}var _this$couponUserItem$ = this.couponUserItem.coupon,type = _this$couponUserItem$.type,value = _this$couponUserItem$.value;if (type === 0) {return '-￥' + value;} else {return '打' + value + '折';}}, timeDownText: function timeDownText() {var msg = '';switch (this.status) {case '待支付':msg = '取消';break;case '待收货':msg = '确认';break;case '待发货':return '等待商家发货';break;case '退款中':return '等待商家审核';break;
        case '已签收':
          return '订单已签收';
          break;}

      if (msg !== '' && this.timeDown !== '') {
        return "\u8FD8\u5DEE ".concat(this.timeDown, " \u81EA\u52A8").concat(msg);
      }
      return '';
    } },
  ...
  methods: {
    ...
    getData: function getData() {var _this2 = this;
      ...
      then(function (res) {
        console.log(res);
        _this2.end_time = res.end_time ? res.end_time : 0;
        _this2.no = res.no;
        _this2.address = res.address;
        _this2.total_price = res.total_price;
        _this2.remark = res.remark;
        _this2.paid_time = res.paid_time;
        _this2.payment_method = res.payment_method;
        _this2.payment_no = res.payment_no;
        _this2.refund_status = res.refund_status;
        _this2.ship_status = res.ship_status;
        _this2.extra = res.extra;
        _this2.create_time = res.create_time;
        _this2.update_time = res.update_time;
        _this2.reviewed = res.reviewed;
        // 整理商品列表数据
        var order_items = res.orderItems.map(function (v) {
          var attrs = [];
          if (v.skus_type === 1 && v.goodsSkus && v.goodsSkus.skus) {
            var skus = v.goodsSkus.skus;
            for (var k in skus) {
        ...
        _this2.couponUserItem = res.couponUserItem;
      });
    },
    // 去支付
    ...
    // 取消订单
    closeOrder: function closeOrder() {var _this3 = this;
      uni.showModal({
        content: '是否要取消该订单？',
        success: function success(res) {
          if (res.confirm) {
            ...
            _this3.$H.post('/closeorder/' + _this3.id, {}, {
              token: true }).
            then(function (res) {
              uni.hideLoading();
              uni.navigateBack({
    ...
    // 确认收货
    received: function received() {var _this4 = this;
      uni.showModal({
        content: '是否要确认收货？',
        success: function success(res) {
          if (res.confirm) {
            ...
            _this4.$H.post('/order/' + _this4.id + '/received', {}, {
              token: true }).
            then(function (res) {
              uni.hideLoading();
              uni.navigateBack({
